...
R code to accompany "Empirical Variational Bayes Factorization for Longitudinal Matrix Data" submitted to *Journal of Computational and Graphical Statistics*.
